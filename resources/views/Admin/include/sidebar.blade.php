<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-right me-3" id="sidenav-main">
    <div class="sidenav-header">
      <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute left-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      @isset($dashboard)
      <a class="navbar-brand m-0" href="{{route('profile.view')}}">
        @if ($dashboard->photo!=null)
        <img src="{{$dashboard->photo}}"
         alt="..." class="w-30 border-radius-lg shadow-sm ">
        @else
        <img src="{{asset('Admin/images/on_imagge.png')}}"
         alt="..." class="w-30 border-radius-lg shadow-sm ">
        @endif
        <span class="me-1 font-weight-bold">{{$dashboard->frist_name.' '.$dashboard->last_name}}</span>
    </a>
    @endisset
    </div>
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link " href="{{route('admin.view')}}">
              ...
              <span class="nav-link-text me-1 text-primary">لوحة التحكم</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="{{route('brand.view')}}">
          ...
          <li class="nav-item">
            <a class="nav-link " href="{{route('attribute.view')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="Rounded-Icons" transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
              ...
              <span class="nav-link-text me-1">الخواص</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="{{route("tage.view")}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <g id="Rounded-Icons" transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
              ...
              <span class="nav-link-text me-1">مساعدات البحث</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="{{route('product.view')}}">
              ...
              <span class="nav-link-text me-1">المنتوجات</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="{{route('slider.view')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
              ...
              <span class="nav-link-text me-1">اسلايدر العرض</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="{{route('banner.view')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center ms-2 d-flex align-items-center justify-content-center">
              ...
              <span class="nav-link-text me-1">الاعللانات</span>
            </a>
          </li>
          <li class="nav-item">
      ...
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        <div class="card-body text-left p-3 ">
            ...
            <a href="{{route('profile.view')}}">
              @if ($dashboard->photo!=null)
              <img src="{{$dashboard->photo}}"
               alt="..." width="140" style="border-radius: 10px">
              @else
              <img src="{{asset('Admin/images/on_imagge.png')}}"
               alt="..."  width="140" style="border-radius: 10px">
              @endif
